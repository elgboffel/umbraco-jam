...
const NETLIFY_PUBLISH_PATH    = join(".", "src/project/mcCode/publish/out_publish/")
...
const NETLIFY_FUNCTIONS_PATH  = join(".", "src/project/mcCode/publish/out_functions/")
...
const NEXT_CONFIG_PATH        = join(".", "src/project/mcCode/next.config.js")
